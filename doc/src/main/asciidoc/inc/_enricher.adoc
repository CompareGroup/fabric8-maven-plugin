...
----
<scm>
    <connection>scm:git:git://github.com/CompareGroup/fabric8-maven-plugin.git</connection>
    <developerConnection>scm:git:ssh://git@github.com/CompareGroup/fabric8-maven-plugin.git</developerConnection>
    <url>git://github.com/CompareGroup/fabric8-maven-plugin.git</url>
  </scm>
